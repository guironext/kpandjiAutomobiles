...
const slides = [
  ...
  },
  {
    ...
    units: [
      ...
      { id: 2, name: "Accélération", unit: "0 à 100km/h", value: "10,5s" },
...
function Latest() {
  ...
  return (
    ...
    <div
      ...
      style={{
        backgroundImage: `url('/assets/accueil/sortie/bg1.png')`,
      }}
    >
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-black/20 bg-opacity-10 z-0" />
